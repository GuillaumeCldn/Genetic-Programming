...
testTree1 = ob.Tree('test1')
testTree1.nodes = [ob.Node('function', '+', op.addOperator), 
                  ob.Node('parameter', 'x', np.linspace(-np.pi/2, np.pi/2, 500)), 
                  ob.Node('function', '@', op.divOperator),
                  ob.Node('None', 'Ø', None), 
                  ob.Node('None', 'Ø', None), 
                  ob.Node('function', '@', op.divOperator), 
                  ob.Node('function', '+', op.addOperator), 
                  ob.Node('None', 'Ø', None), 
                  ob.Node('None', 'Ø', None), 
                  ob.Node('None', 'Ø', None), 
                  ob.Node('None', 'Ø', None),
                  ...
                  ob.Node('None', 'Ø', None),  
                  ob.Node('constant', str(2), 2), 
                  ob.Node('constant', str(0), 0), 
                  ob.Node('constant', str(0), 0), 
                  ob.Node('constant', str(4), 4),
                  ob.Node('constant', str(1), 1), 
                  ob.Node('constant', str(-2), -2),   
                  ob.Node('parameter', 'x', np.linspace(-np.pi/2, np.pi/2, 500)), 
                  ob.Node('parameter', 'x', np.linspace(-np.pi/2, np.pi/2, 500)) 
                  ]
testTree1.update_param()
